    ...
    try {
      ...
      QRCode.toDataURL(OCRData, { width: 300 }, async (err, dataUrl) => {
        ...
        beforePages.forEach((page, pageIndex) => {
          ...
          console.log(`Before: Page ${pageIndex + 1} Rotation: `, pageRotation);
        });
        ...
        await Promise.all(
          pdfDoc.getPages().map(async (page) => {
            ...
            newPage.drawPage(embedPage, {
              // x: 0,
              // y: 0,
              x: page.getWidth() / 2 - page.getHeight() / 2 - 90 - 10 - 5,
              y: page.getHeight() + page.getWidth() / 2 - 180,
              rotate: degrees(-90),
            });
            return embedPage;
          })
        ...
        afterPages.forEach((page, pageIndex) => {
          const pageRotation = page.getRotation().angle;
          console.log(`After: Page ${pageIndex + 1} Rotation: `, pageRotation);
        });
